...
//		page.frameLocator("#firstFr").getByPlaceholder("Enter name").type("Mahesh");
		FrameLocator framelocator =  page.frameLocator("#firstFr");
		framelocator.getByPlaceholder("Enter name").type("Mahesh");
		framelocator.getByPlaceholder("Enter email").type("Rampatruni");
		FrameLocator chaildframe = framelocator.frameLocator("iframe.has-background-white");
		chaildframe.getByPlaceholder("Enter email").fill("mahirampo@gmail.com");
